...
public class RobolectricUnitTestRunner extends RobolectricGradleTestRunner {
    ...
    public RobolectricUnitTestRunner(@NonNull Class<?> klass) throws Exception {
        super(klass);
    }
    ...
    public Config getConfig(@NonNull Method method) {
        ...
        return new Config.Implementation(
                ...
                ApplicationSIPTest.class, // Notice that we override real application class for Unit tests.

 ...
 * @author e.matsyuk
 */
public class DocumentViewResources implements IViewResources {
    ...
    public int getDownloadImage() {
        return R.drawable.progress_document_download_icon;
    }

    @Override
    public int getDownloadInner() {
        return R.drawable.progress_document_download_inner;
    }
}
